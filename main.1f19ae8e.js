...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/random-words/index.js":[function(require,module,exports) {
var wordList = [
...
var categoryValue = document.querySelector("#category-select");
categoryValue.addEventListener("change", categorySelect);
var myButton = document.querySelector(".myButton");
var myHeader = document.querySelector(".buttonDiv");
var randomWord;
...
var myKeyBoard = document.querySelector(".container");
myKeyBoard.addEventListener("click", findLetter);
var score = 0;
var myhanger = document.querySelector(".hangman-img");
...
function findLetter(evt) {
    ...
    for (var _i2 = 0; _i2 < randomWord.length; _i2++) {
      if (evt.target.id == document.getElementById("".concat(_i2)).textContent) {
        ...
        if (score == randomWord.length) {
          var _msg = new SpeechSynthesisUtterance("".concat(winningMsg[randomWmessage]));
  ...
  if (!randomWord.includes("".concat(evt.target.id))) {
    ...
    if (lifes == 2) {
      var _msg2 = new SpeechSynthesisUtterance("1 more chance");

      _msg2.rate = 0.95;
      window.speechSynthesis.speak(_msg2);
    }
    ...
    if (lifes <= 1) {
      ...
      var _msg3 = new SpeechSynthesisUtterance("".concat(loosingMsg[randomMsg], " the answer was ") + randomWord.toLocaleLowerCase());

      _msg3.rate = 0.9;
      window.speechSynthesis.speak(_msg3);
      setTimeout(function () {
        location.reload();
      }, 7000);
    }
    ...
    if (img < 5) {
      ...
      myhanger.appendChild(_hangImg2);
      console.log("true");
    }
  }
}
